 ...
 */
public class EmailAuthorizationFailedPasswordSteps {
    ...
    public void DataIsNotCorrect()  {
        ...
        if(webDriver.findElement(By.xpath(xPathDataIsNotCorrectAlert)).getText() == "Логин или пароль неправильны.") flug = true;
